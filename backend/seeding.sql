...
(21, 'iPad Pro M4 13 inch Wifi 256GB', '<ul><li>Màn hình: 13 inch Ultra Retina XDR, 120Hz ProMotion, 1000 nits</li><li>Chip: Apple M4 (9 lõi CPU)</li><li>RAM/ROM: 8GB/256GB</li><li>Camera: Sau 12MP, Trước 12MP Ultra Wide</li><li>Hệ điều hành: iPadOS 17</li><li>Tương thích: Apple Pencil Pro, Magic Keyboard M4</li></ul>', 5000000, 500000, 5000000, 36290000, 0, 14, 'b0eebc99-9c0b-4ef8-bb6d-6bb9bd380b22', null, 'ACTIVE', DATE_ADD(NOW(), INTERVAL 4 DAY), 'ipad pro m4 13 inch wifi 256gb ultra retina xdr apple m4', NOW());
-- ======================================================================================
