...
//
//    public AutoBidService(AutoBidRepository autoBidRepository, BidHistoryRepository bidHistoryRepository, ProductRepository productRepository, UserRepository userRepository, BlockedBidderRepository blockedBidderRepository, RatingRepository ratingRepository, AutoBidMapper autoBidMapper, BidHistoryMapper bidHistoryMapper) {
...
//        this.autoBidMapper = autoBidMapper;
//        this.bidHistoryMapper = bidHistoryMapper;
//    }
//
//    @Transactional
...
//            throw new BadRequestException("Sản phẩm không trong trạng thái đấu giá");
//        }
//
//        // Check đã hết hạn chưa
//        if (product.getThoiGianKetThuc().isBefore(LocalDateTime.now())) {
//            throw new BadRequestException("Sản phẩm đã kết thúc đấu giá");
//        }
//
...
//            // Giá = max(giá khởi điểm, giá hiện tại)
//            newPrice = product.getGiaHienTai().max(product.getGiaKhoiDiem());
//        } else {
//            // Có >= 2 người đấu giá
...
//     */
//    @Transactional
//    public void cancelAutoBid(Long bidderid, Long autobidid) {
...
////            throw new HttpClientErrorException.Forbidden("Bạn không có quyền hủy autobid này");
////        }
//
//        // Đánh dấu inactive
