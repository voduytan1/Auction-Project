...
public class SecurityConfig {
    private static final Map<String, Map<HttpMethod, String[]>> ROLE_BASED_ENDPOINTS = Map.of(
            "PUBLIC", Map.of(
                    HttpMethod.GET, new String[]{"/auth/**", "/actuator/**", "/categories","/categories/{id}", "/categories/{id}/products", "/categories/{id}/sub-category","/products", "/products/{id}", "/bids/history/{productId}/get-top", "/questions"},
